				...
				<div>
					...
					<div class="row">
						...
						<div class="page-heading col-sm-11"
							...
							<span class="glyphicon glyphicon-user"></span> Branches Details</b> <label
								style="margin-left: 250px; margin-top: 8px;"><a
								href="addbranchbystate" class="btn btn-primary">Add Branches</a>
						...
						<c:if test="${!empty branchlist}">
							<c:forEach items="${branchlist}" var="branch" varStatus="loop">
								<tr>
									...
									<td><a
										href="editbranch?id=${branch.branchId}&stateid=${stateid}"
										title="Edit"><span class="glyphicon glyphicon-pencil"></span></a></td>
									<td><a href="deletebranch?id=${branch.branchId}"
