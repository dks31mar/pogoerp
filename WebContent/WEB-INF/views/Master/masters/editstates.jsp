...
<div class="container">
	...
	<form:form class="well form-horizontal"
		action="updatestates?id=${zonid}" method="POST"
		commandName="statezoneBean">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							name="stateId" class="form-control" readonly="readonly"
							value="${liststate.stateId}">
					</div>
				</div>
			</div>
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							value="${liststate.stateName}" class="form-control" type="text">
