...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> Add Plan <label
		...
		<div class="row">
			...
			<div class="col-md-10" align="right" id="dddd1234">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="addplan"
					style="border-radius: 5px;" value="" name=""
					placeholder="Add Plan " maxlength="20" autofocus="autofocus"
			...
			<c:if test="${!empty planList}">
				<c:forEach items="${planList}" var="action" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${action.id})" title="Edit"><span
								class="glyphicon glyphicon-pencil"></span></a></td>
						<td style=""><a href="deleteAddPlan?addplanid=${action.id}"><span
