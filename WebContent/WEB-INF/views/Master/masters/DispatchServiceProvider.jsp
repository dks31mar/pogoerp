...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class=""></span> Service Provider <label
			style="margin-left: 850px;"> <a href="getserviceprovider"
			...
			<c:if test="${!empty servicelist}">
				<c:forEach items="${servicelist}" var="cur" varStatus="loop">
					...
					<tr>
						...
						<td><a
							href="editserviceprovider?id=${cur.transportationserviceid}"
							title="Edit" align="center"> <span
								class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a
							href="deleteserviceprovider?id=${cur.transportationserviceid}"><span
