...
<div class="row">
  <div class="col-md-4"><span style="color: black;"> <strong>Name<span style="color: red;">*</span>:
  
						</strong></span></div>
  <div class="col-md-4"><span style="color: black;">
							<strong>Address<span style="color: red;">*</span>:
						</strong>
					</span></div>
  <div class="col-md-4"><span style="color: black;"> <strong>Currency<span
...
<input type="hidden" id="hiddenid"/>
  <div class="col-md-4"><input path="loginname" type="text" class="validate[required] text-input" id="supname"
						style="border-radius: 5px;" value="" name="loginname"
						maxlength="20" autofocus="autofocus" onclick="hidemsg();return false;">
						
						 <div id="msg1" align="left"><span style="color: red">*Mandtory Field</span> </input></div></div>
						
  <div class="col-md-4">
  <input path="loginname" type="text" class="validate[required] text-input" id="supadr"
						style="border-radius: 5px;" value="" name="loginname" onclick="hidemsg();return false;"
						maxlength="20" autofocus="autofocus">
						<div id="msg2" align="left"><span style="color: red">*Mandtory Field</span></input>
						</div>
						</div>
  <div class="col-md-4"><input path="firstname" type="text" class="validate[required] text-input" id="supcur"
						style="border-radius: 5px;" name="firstname" value="" onclick="hidemsg();return false;"
						 maxlength="20">
						 <div id="msg3" align="left"><span style="color: red">*Mandtory Field</span></input>
						</div>
						</div>
