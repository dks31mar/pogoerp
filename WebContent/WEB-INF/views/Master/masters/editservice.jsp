				...
				<div class="form-group">
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${service.transportationserviceid}" name="zonesid"
								placeholder="Region Name" id="serid" class="form-control"
								type="hidden"> <input value="${service.servicename}"
								name="zonesname" placeholder="Name" id="transportname"
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input
								value="${service.contactperson}" name="zonesname"
								placeholder="Contact person name" id="contactperson"
								class="form-control" type="text">
						</div>
					</div>
				</div>
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${service.mobile}" class="form-control"
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${service.phone}" placeholder="Phone Number"
								class="form-control" id="phoneno" required="required"
								type="email">
						</div>
					</div>
				</div>
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${service.serviceaddress}" placeholder="Address"
								class="form-control" id="address" required="required"
								type="Text">
						</div>
					</div>
					<label class="col-md-2 control-label">Transport Mode<span
						style="color: red;">*</span></label>
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <select name="subcompany"
								class="form-control selectpicker" required="required" id="mode">
								<option value="${service.transportationmodeid}"
									selected="selected">${service.transportationmodeid}</option>
				...
				<div class="form-group">
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-home"></i></span> <input
								value="${service.email}" placeholder="E-Mail Address"
								class="form-control" id="email" required="required" type="text">
						</div>
					</div>
