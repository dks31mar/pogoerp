...
<div id="body">
	...
	<form:form class="well form-horizontal" name="forp" action=""
		method="POST" commandName="userbean" id="">
		<!-- Form Name -->
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						class="form-control" pattern="^[a-zA-Z](\s?[a-zA-Z]){2,20}$"
						type="text">
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder="Contact Person" id="contactper" class="form-control"
						pattern="[a-zA-Z0-9]+" type="text">
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						class="form-control" id="phone2" placeholder="(845)555-1212"
		...
		<div class="form-group">
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-earphone"></i></span> <input name="lastname"
						placeholder="Mobile No" id="phone1" class="form-control"
						pattern="^\d{1,10}$" type="text">
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-lock"></i></span> <input name="Product"
						placeholder=" Product Brand" id="productbrand" required="required"
						class="form-control" type="text"> <span style="color: red"
						id="msg6">*This field is required.</span>
				</div>
			</div>
		</div>
		<div class="form-group">
...
-->
		...
		<div class="form-group">
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-lock"></i></span> <input name="firstname"
						placeholder="Product Name" id="productname" required="required"
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-list"></i></span> <select name="department"
						class="form-control selectpicker" required="required" id="freeamc"
						placeholder="Select Free AMC">
						<option></option>
		...
		<!-- <div class="form-group"> -->
		<label class="col-md-2 control-label">Price(Rs.)<span
			style="color: red;">*</span></label>
		<div class="col-md-3 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i
					class="glyphicon glyphicon-doller"></i></span> <input name="price"
					class="form-control" placeholder="Rupees" type="text"
		...
		<div class="form-group">
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-lock"></i></span> <input name="Product Name"
						class="form-control" id="rateamc" placeholder="AMC Rate"
 ...
 -->
		...
		<div class="form-group">
			...
			<div class="col-md-2" align="center">
				<button type="button" class="btn btn-warning" onclick="message();"
					id="senddata">
