...
<form:form class="well form-horizontal" action="upcompetitior"
	method="POST" commandName="competitiorsProfileBean" id="">
	...
	<fieldset>
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						name="compid" placeholder=" Name" id="name"
						value="${listofcompetitior.compid}" required="required"
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder=" Name" id="name" value="${listofcompetitior.name}"
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						value="${listofcompetitior.contactperson}" id="contactper"
						class="form-control" type="text">
				</div>
			</div>
		</div>
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						value="${listofcompetitior.address}" placeholder="Address"
						id="address" class="form-control" type="text">
				</div>
			</div>

			<label class="col-md-2 control-label" style="margin-left: -62px;">Phone
				No</label>
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-phone-alt"></i></span> <input name="phoneno"
						class="form-control" id="phone2"
						value="${listofcompetitior.phoneno}" placeholder="(845)555-1212"
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder="Mobile No" id="phone1"
						value="${listofcompetitior.mobileno}" class="form-control"
						type="text">
				</div>
			</div>

			<label class="col-md-2 control-label" style="margin-left: -62px;">Product
				Brand<span style="color: red;">*</span>
			</label>
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-lock"></i></span> <input name="productbrand"
						placeholder=" Product Brand" id="product" required="required"
						value="${listofcompetitior.productbrand}" class="form-control"
						type="text">
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder="E-Mail Address" class="form-control" id="email1"
						value="${listofcompetitior.emailid}" required="required"
						type="email">
			...
			<label class="col-md-2 control-label" style="margin-left: -62px;">Warranty
				Period</label>
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-list"></i></span> <select
						name="warrentyperiod" class="form-control selectpicker"
						required="required" value="${listofcompetitior.warrentyperiod}"
						id="warranty">
		...
		<div class="form-group">
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-lock"></i></span> <input name="productname"
						placeholder="ProductName" value="${listofcompetitior.productname}"
						id="firstUpper" required="required" class="form-control"
						type="text">

				</div>
			</div>
			<label class="col-md-2 control-label" style="margin-left: -62px;">NO
				of Free AMC<span style="color: red;">*</span>
			</label>
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-list"></i></span> <select name="nooffreeamc"
						class="form-control selectpicker" required="required"
						value="${listofcompetitior.nooffreeamc}" id="freeamc">
		...
		<div class="form-group">
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-doller"></i></span> <input name="price"
						class="form-control" type="text" required="required"
						value="${listofcompetitior.price}" id="price">
				</div>
			</div>
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-lock"></i></span> <input name="amcrate"
						class="form-control" placeholder="AMC Rate" required="required"
						type="text" value="${listofcompetitior.amcrate}" id="amcrate">
