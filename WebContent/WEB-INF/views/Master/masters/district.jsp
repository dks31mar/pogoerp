...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-home"></span> District <label
	...
	<div id="formid" class="col-md-11" style="left: 20px; height: 34px;">
		...
		<div class="row">
			<input type="hidden" id="hiddenid" /> <input type="hidden"
				id="locationid" value="${state123}" />
			<div class="col-md-10" align="right">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="adddistrict"
					style="border-radius: 5px;" value="" name="loginname"
					placeholder="Add District" autofocus="autofocus"></input>
			</div>
			...
			<c:if test="${!empty districtList}">
				<c:forEach items="${districtList}" var="district" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${district.districtId})"
							title="Edit"> <span class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a
							href="deletedistrict?districtId=${district.districtId}"><span
