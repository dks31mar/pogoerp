...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> Team/Segment <label
		...
		<div class="row">
			...
			<div class="col-md-10" align="right">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="addteam"
					style="border-radius: 5px;" value="" name="loginname"
					placeholder="Add Team" autofocus="autofocus"></input>
			</div>
			...
			<c:if test="${!empty teamsegmentlist}">
				<c:forEach items="${teamsegmentlist}" var="state" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${state.teamid})"
							title="Edit"> <span class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a href="deleteteam?teamid=${state.teamid}"><span
