...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> Add Action <label
		...
		<div class="row">
			...
			<div class="col-md-10" align="right" id="dddd1234">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="addaction"
			...
			<c:if test="${!empty actionList}">
				<c:forEach items="${actionList}" var="action" varStatus="loop">
					<tr>
						...
						<td style=""><a
							href="deleteaddAction?addActionid=${action.id}"><span
