...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-home"></span> State <label
		...
		<div class="row">
			...
			<div class="col-md-10" align="right">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="addstate"
					style="border-radius: 5px;" value="" name="loginname"
					placeholder="Add State" autofocus="autofocus"></input>
			</div>
			...
			<c:if test="${!empty stateList}">
				<c:forEach items="${stateList}" var="state" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${state.stateId})"
							title="Edit"> <span class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a href="deletestate?stateId=${state.stateId}"><span
