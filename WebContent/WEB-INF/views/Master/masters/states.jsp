				...
				<div>
					...
					<div class="row">
						...
						<div class="page-heading col-sm-11"
							...
							<span class="glyphicon glyphicon-user"></span> States Details</b> <label
								style="margin-left: 250px; margin-top: 8px;"><a
								href="addstates" class="btn btn-primary">Add States</a> </label>
							...
							<c:if test="${!empty satyendra}">
								<c:forEach items="${satyendra}" var="state" varStatus="loop">
									...
									<tr>
										...
										<td><a href="getbranchbystate?id=${state.stateId}"
											target="_blank">Branches</a></td>
										<td><a
											href="editstates?id=${state.stateId}&id2=${zoneid}"
											title="Edit" id=""><span
												class="glyphicon glyphicon-pencil"></span></a></td>
										<td><a href="deleteState?id=${state.stateId}"
