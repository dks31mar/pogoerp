...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-home"></span> Location <label
	...
	<div id="formid" class="col-md-11" style="left: 20px; height: 34px;">
		...
		<div class="row">
			<input type="hidden" id="hiddenid" /> <input type="hidden"
				id="districtid" value="${district123}" />

			<div class="col-md-10" align="right" id="dddd1234">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="addlocation"
					style="border-radius: 5px;" value="" name="loginname"
					placeholder="Add location" autofocus="autofocus"
			...
			<div class="col-md-2" align="left">
				<button type="button" class="btn btn-primary" id="saveForm123">Save</button>
			...
			<c:if test="${!empty locationList}">
				<c:forEach items="${locationList}" var="location" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${location.locationId})"
							title="Edit"> <span class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a
							href="deletelocation?locationId=${location.locationId}"><span
