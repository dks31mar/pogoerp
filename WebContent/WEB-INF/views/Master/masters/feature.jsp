		...
		<div>
			...
			<div class="row">
				...
				<div class="page-heading col-sm-11"
					...
					<span class="glyphicon glyphicon-user"></span>Competitor Details</b> <label
						style="margin-left: 250px; margin-top: 8px;"><a
						href="competitiorsProfile" class="btn btn-primary">Add
							Competitor</a> </label>
				...
				<c:if test="${!empty compList}">
					<c:forEach items="${compList}" var="list" varStatus="loop">
						...
						<tr>
							...
							<td><a href="editcompetitior?id=${list.compid}" title="Edit"
								id="edit`"><span class="glyphicon glyphicon-pencil"></span></a></td>
							<!-- <td><a href="" title="Edit" id=""><span class="glyphicon glyphicon-trash"></span></a></td> -->
							<td style=""><a href="deletefeature?id=${list.compid}"><span
