...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="fa fa-money"></span> Expense Head <label
			style="margin-left: 250px; margin-top: 8px;">
			<button href="#" class="btn btn-primary" id="getexpenseheadpopup"
				style="margin-bottom: -25px; margin-top: -26px; HEIGHT: 28px; margin-left: 561px;">
				Add ExpenseHead</button>
		</label>
	...
	<div id="formid" class="col-md-11" style="left: 20px; height: 34px;">
		<div class="row">
			<div class="col-md-3">
				<span style="color: black;"> <strong>Expense Head<span
						style="color: red;">*</span>:
				</strong></span>
			</div>

			<div class="col-md-3">
				<span style="color: black;"><strong>Expense Type<span
						style="color: red;">*</span>:
				</strong></span>
			</div>

			<div class="col-md-3">
				<span style="color: black;"> <strong>Unit<span
						style="color: red;">*</span>:
				</strong></span>
			</div>

			<div class="col-md-3">
				<span style="color: black;"> <strong>Limit/Rate Rs.<span
						style="color: red;">*</span>:
				</strong></span>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<input type="text" class="validate[required] text-input"
					id="expensehead" style="border-radius: 5px;" value=""
					name="loginname" autofocus="autofocus"></input>

			</div>
			<div class="col-md-3">
				<input type="text" class="validate[required] text-input"
					id="expensetype" style="border-radius: 5px;" value=""
					name="loginname" autofocus="autofocus"></input>
			</div>
			<div class="col-md-3">
				<input type="number" class="validate[required] text-input" id="unit"
					style="border-radius: 5px;" name="firstname" value=""></input>
			</div>
			<div class="col-md-3">
				<input type="number" class="validate[required] text-input"
					id="limit" style="border-radius: 5px;" name="firstname" value=""
					maxlength="20"></input>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12" align="right">
				<button style="margin-left: 300px; margin-top: -31px;" type="button"
					class="btn btn-primary" id="saveexpenseheaderForm">Save</button>
			</div>
			<div class="col-md-12" align="right">
				<button style="margin-left: 300px; margin-top: -31px;" type="button"
					class="btn btn-primary" id="EditcurrencyForm">Edit</button>
			</div>
		</div>
			...
			<c:if test="${!empty expenseheadList}">
				<c:forEach items="${expenseheadList}" var="cur" varStatus="loop">
					...
					<tr>
						...
						<td>${cur.unit}</td>
						<td>${cur.exlimit}</td>
						<td><a href="#" onclick="editCur(${cur.expensemasterId})"
							title="Edit" align="center"><span
								class="glyphicon glyphicon-pencil"></span></a></td>
						<td style=""><a
							href="deleteexpenseheader?expensemasterId=${cur.expensemasterId}"><span
