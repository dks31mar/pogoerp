...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> Customer Source <label
			style="margin-left: 250px; margin-top: 8px;"><button
				...
				Add Customer Source</button> </label>
	...
	<div id="formid" class="col-md-11" style="left: 20px; height: 34px;">
		...
		<div class="row">
			...
			<div class="col-md-10" align="right" id="dddd1234">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="addsource"
					style="border-radius: 5px;" value="" name="loginname"
					placeholder="Add Customer Source " maxlength="20"
					autofocus="autofocus" onclick="stopmoving();"></input>
			</div>
			...
			<div class="col-md-2" align="left">
				...
				<button type="button" class="btn btn-primary" id="EditForm">Edit</button>
		...
		<div class="row">
			...
			<div class="col-md-10" align="right" id="messagediv">
				<span style="color: red;">*Mandatory filed</span>
			</div>
	...
	<table class="responstable" style="margin-left: 22px;">
		...
		<tbody>
			...
			<c:if test="${!empty customersourcelist}">
				<c:forEach items="${customersourcelist}" var="customersource"
					varStatus="loop">
					...
					<tr>
						...
						<td><a href="#"
							onclick="editCur(${customersource.customersourceId})"
							title="Edit"> <span class="glyphicon glyphicon-pencil"></span></a></td>
						<td style=""><a
							href="deletecustomersource?customersourceId=${customersource.customersourceId}"><span
