...
<div class="container">
	...
	<form:form class="well form-horizontal" name="forp"
		action="update-region" method="POST" commandName="zonesBean" id="">
  ...
  -->
			<div class="form-group">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							class="glyphicon glyphicon-user"></i></span> <input name="zonesname"
							placeholder="Region Name" value="${getregion.zonesname}"
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							class="glyphicon glyphicon-user"></i></span> <select name=""
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							name="zonesphone" class="form-control"
							value="${getregion.zonesphone}" placeholder="8285080678"
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							name="zonesemail" placeholder="E-Mail Address"
							value="${getregion.zonesemail}" class="form-control"
			...
			<div class="form-group">
				...
				<div class="col-md-3 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							class="glyphicon glyphicon-envelope"></i></span> <input name="zonesfax"
							placeholder="Fax Address" value="${getregion.zonesfax}"
							class="form-control" required="required" type="fax">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							class="form-control" name="zonesaddress"
							value="${getregion.zonesaddress}" placeholder="Address"
							required="required">
					</div>
				</div>
			</div>
