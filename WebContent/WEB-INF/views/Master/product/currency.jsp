...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="fa fa-money"></span> Currency Master Details <label
			style="margin-left: 250px; margin-top: 8px;">
			<button href="#" class="btn btn-primary" id="getpopup"
	...
	<div id="formid" class="col-md-11" style="left: 20px; height: 34px;">
		<div class="row">
			<div class="col-md-4">
				<span style="color: black;"> <strong>Currency Name<span
						style="color: red;">*</span>:

				</strong></span>
			</div>
			<div class="col-md-4">
				<span style="color: black;"> <strong>Currency Type<span
						style="color: red;">*</span>:
				</strong>
				</span>
			</div>
			<div class="col-md-4">
				<span style="color: black;"> <strong>Currency Symbol<span
						style="color: red;">*</span>:
		...
		<div class="row">
			...
			<div class="col-md-4">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="currencyname"
					style="border-radius: 5px;" value="" name="loginname"
					maxlength="20" autofocus="autofocus">

				<div id="msg1" align="center">
					<span style="color: red">* please fill the currencyname</span> </input>
				</div>
			</div>

			<div class="col-md-4">
				<select class="selectpicker" data-style="btn-success" name=""
					id="currencytypeid" style="border-radius: 5px;">
			...
			<div class="col-md-4">
				<input path="firstname" type="text"
					class="validate[required] text-input" id="currencysymbol"
					style="border-radius: 5px;" name="firstname" value=""
					maxlength="20">
				<div id="msg2" align="center">
					<span style="color: red">*please fill the currencysymbol</span></input>
				</div>
			</div>
			...
			<c:if test="${!empty currencylist}">
				<c:forEach items="${currencylist}" var="cur" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${cur.currencyid})"
							title="Edit" align="center"> <span
								class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a href="deletecurrency?id=${cur.currencyid}"><span
