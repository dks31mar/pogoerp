...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="fa fa-balance-scale"></span> Product Head <label
		...
		<div class="row">
			...
			<div class="col-md-10" align="right">
				<input path="loginname" type="text"
					...
					placeholder="Enter Product Name" maxlength="20"
			...
			<c:if test="${!empty productlist}">
				<c:forEach items="${productlist}" var="product" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${product.productheadid})"
							title="Edit" align="center"> <span
								class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a
							href="deleteproducthead?id=${product.productheadid}"><span
