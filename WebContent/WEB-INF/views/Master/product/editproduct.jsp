					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${product.productid}" name="" id="productid"
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${product.productcode}" placeholder="Enter Product Code"
				...
				<div class="form-group">
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input
								value="${product.productname}" name="loginname"
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								name="address" placeholder="Product Description"
				...
				<div class="form-group">
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input
								value="${product.costprice}" name="designation"
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input
								value="${product.sellingprice}" name="middlename"
				...
				<div class="form-group">
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input
								value="${product.color}" name="lastname" id="productcolor"
								placeholder="Product Colour" id="firstlastupper"
