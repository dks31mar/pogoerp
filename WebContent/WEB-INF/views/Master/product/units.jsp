		...
		<div class="row">
			...
			<div class="col-md-10" align="right">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="unitname"
					style="border-radius: 5px;" value="" name="loginname"
					placeholder="Enter Unit Name" maxlength="20" autofocus="autofocus"></input>
			...
			<c:if test="${!empty unitlist}">
				<c:forEach items="${unitlist}" var="unit" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${unit.unittypeid})"
							title="Edit" align="center"> <span
								class="glyphicon glyphicon-pencil"></span></a></td>

						<td style=""><a href="#"
							onclick="deletedata(${unit.unittypeid})"><span
