...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		Designation <label style="margin-left: 250px; margin-top: 2px;"><a
			href="#" class="btn btn-success"> Level </a> </label> <label
			style="margin-left: 250px; margin-top: 2px;"><a href="#"
			class="btn btn-primary"> Authority </a> </label>
...
<div class="container" id="mainidtable">
	...
	<form:form class="well form-horizontal" action="saveDesignation"
		method="POST" commandName="designationbean" id="">
		<fieldset>
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							placeholder="Add New Designation" type="text" id="newdesg">
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<div class="radio" id="radioDiv">
							<label> <input type="radio" name="position" value="0" />
								Above
							</label> <label> <input type="radio" name="position" value="1" />
								Below
							</label> <label> <input type="radio" name="position" value="2" />
								Same
							</label>
						</div>
					</div>
					<div class="col-md-4 selectContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								class="form-control selectpicker" id="dedig">
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<button type="button" class="btn btn-warning" id="sendLevel">
				...
				<c:if test="${!empty designationlist}">
					<c:forEach items="${designationlist}" var="data" varStatus="deg">
						...
						<tr>
							...
							<td><a href="editDesignation?id=${data.designationid}"
								title="Edit"><span class="glyphicon glyphicon-pencil"></span></a></td>
							<td><a href="deleteDesg?designationid=${data.designationid}"
