...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> Add Department <label
		...
		<div class="row">
			...
			<div class="col-md-10" align="right" id="dddd1234">
				<input path="loginname" type="text"
					class="validate[required] text-input" id="department"
					style="border-radius: 5px;" value="${actionlist.action}" name=""
					placeholder="Add Action " maxlength="20" autofocus="autofocus"
					onclick="stopmoving();"></input>
			</div>
			...
			<c:if test="${!empty bean}">
				<c:forEach items="${bean}" var="data" varStatus="loop">
					<tr>
						...
						<td><a href="#" onclick="editCur(${data.depId})" title="Edit"><span
								class="glyphicon glyphicon-pencil"></span></a></td>
						<td style=""><a
							href="deleteDepartment?departmentid=${data.depId}"><span
