...
<div id="body">
	<div class="container">
		...
		<form:form class="well form-horizontal" action="saveBranch"
			method="POST" commandName="branchBean" id="">
					...
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								placeholder="Branch Name" class="form-control" type="text">

						</div>
					</div>

					<label class="col-md-2 control-label" style="margin-left: -62px;">Branch
						Head<span style="color: red;">*</span>
					</label>
					<div class="col-md-3 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <select name="branchId"
