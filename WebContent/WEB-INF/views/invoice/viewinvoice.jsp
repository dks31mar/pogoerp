...
<form method="POST" action="">
	...
	<div style="border: 1px solid #CCCCCC; padding: 7px; width: 93%">
		...
		<div class="row form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="Dispatch" id="Dispatchid" size="1"
					placeholder="Dispatch Doc No" class="form-control">
			...
			<div class="col-sm-3">
				<input type="text" name="dispatchthrough"
					placeholder="Dispatch through" onkeyup="" id="customerid" value=""
					class="form-control">
		...
		<div class="row form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="OrderReceiveDate"
					placeholder="Terms of Delivery" value="" class="form-control"
					style="display: inline-block;" id="receivedate">
			</div>
		...
		<table style="width: 100%; bottom: 15px; position: relative;"
			...
			<thead>
				<tr bgcolor="#3C8DBC">
					...
					<td class="col-sm-3 form-level" style="width: 80px" align="center">&nbsp;<font
						size="2" color="white"> <label> Dispatch Qty</label></font></td>


					<td align="center">&nbsp;<font size="2" style="width: 80px"
						color="white"> <label id="tpinchangelable">Pending
								Qty</label></font></td>



					<td align="center">&nbsp;<font size="2" style="width: 80px"
						color="white"> <label id="dis">Order Amount</label></font></td>
					<td align="center">&nbsp;<font size="2" style="width: 80px"
						color="white"> <label id="netprice">Dispatch Amount</label></font></td>
		...
		<table>
			<tr>
				...
				<td style="right: 7px; position: relative;">&nbsp; <input
					type='text' style='text-align: center;' name='DispatchQty'
					id='Dispatchid' value="" class='form-control' /></td>



				<td style="right: 7px; position: relative;">&nbsp; <input
					type='text' style='text-align: center;' name='pendingqty'
					id='pendingid' value="" class='form-control' /></td>



				<td style="right: 7px; position: relative;">&nbsp; <input
					type='text' style='text-align: center;' name='orderamount'
					id='amountid' value="" class='form-control' /></td>

				<td style="right: 7px; position: relative;">&nbsp; <input
					type='text' style='text-align: center;' name='dispatchamount'
					id='disamountid' value="" class='form-control' /></td>
				...
				<td align="center">&nbsp; <input type="button" value='+'
					...
					data-toggle='tooltip' title='Add More Product' /></td>
			</tr>
...
<div class="row form-group" style="top: 10px; position: relative;"
	...
	<div align="right">
		<input type="text" name="Ordervalue" id="orderid" class="form-control"
...
<div class="row form-group" style="top: 10px; position: relative;"
	onclick="">
	<div class="col-sm-10 form-level" align="right">
		Dispatch Net Value:<font color="#FF0000"></font>
	</div>
	<div align="right">
		<input type="text" name="dispatchvalue" id="dispatchvalueid"
...
<div class="row form-group" style="top: 10px; position: relative;"
	onclick="">
	<div class="col-sm-10 form-level" align="right">
		VAT(5%):<font color="#FF0000"></font>
	</div>
	<div align="right">
		<input type="text" name="vat" id="vatid" class="form-control"
			value="${total}" style="width: 15%;" readonly>
	</div>
</div>
<div class="row form-group" style="top: 10px; position: relative;"
	onclick="">
	<div class="col-sm-10 form-level" align="right">
		Total Amount:<font color="#FF0000"></font>
	</div>
	<div align="right">
		<input type="text" name="tamount" id="tamountid" class="form-control"
			value="${total}" style="width: 15%;" readonly>
	</div>
</div>
