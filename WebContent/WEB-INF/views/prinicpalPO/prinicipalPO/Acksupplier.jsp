...
<div style="border: 1px solid #CCCCCC; padding: 7px; width: 93%">
				...
				<c:if test="${!empty listbyporef}">
					<c:forEach items="${listbyporef}" var="poref" varStatus="loop">
						...
						<tr>
							...
							<td align="center">&nbsp;
								<button type="button"
									style="text-align: center; width: 99px; background-color: #3C8DBC; color: aliceblue"
									name="customerporefe" id="pendindqty${loop.index+1}"
	...
	<div class="row form-group" position: relative;" onclick=""
		...
		<table id="idoftable">
			<tr>
				<td class="col-sm-4 form-level" align="center">Exp.Delivery
					Date</td>
				<td class="col-sm-4 form-level">Receive Quantity</td>
				<td class="col-sm-4 form-level">Action</td>
			</tr>
