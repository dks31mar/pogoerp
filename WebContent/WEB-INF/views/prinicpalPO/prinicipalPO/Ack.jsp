	...
	<table style="width: 100%; bottom: 15px; position: relative;"
		...
		<tr>
			...
			<td align="center" style="width: 80px">&nbsp;<font size="2">
					<form:label path="">Acknowledgement Entry</form:label>
			</font></td>

			<td align="center" style="width: 50px">&nbsp;<font size="2">
					<form:label path="">Invoice Entry</form:label>
			</font></td>
		...
		<c:if test="${!empty acklist}">
			<c:forEach items="${acklist}" var="view" varStatus="loop">
				...
				<tr>
					...
					<td><a
						href="supplierack?poref=${view.porefno}&page=acknoledment"><c:out
								value="Acknowledgement Entry"></c:out></a></td>
					<td><a href=supplierinvoice?poref=${view.porefno}&page=Invoice><c:out
								value="Invoice Entry"></c:out></a></td>
				</tr>
