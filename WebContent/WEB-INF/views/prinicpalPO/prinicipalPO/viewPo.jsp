...
<div class="row">
	<div class="page-heading col-sm-11"
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="ason" type="radio"
			name="potype" checked="checked"> As On <input id="period"
			type="radio" name="potype" />Period &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
			id="hide1">From:<input type="text" style="color: black;"
			id="datepicker1" value="<%=dateFormat.format(date) %>" ReadOnly></span>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="hide2">To: <input
			type="text" style="color: black" id="datepicker2"
			value="<%=dateFormat.format(date) %>" ReadOnly></span>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit"
			value="Search" style="color: black;" />
	</div>
</div>
...
<form:form method="POST" action="savepodetails" commandName="command">
	<table style="width: 100%; bottom: 15px; position: relative;"
		border="0" id="responstable">
		<tr>

			<td style="width: 10px" align="center">&nbsp;<font size="2">
					<form:label path="">S.No.</form:label>
			</font></td>

			<td style="width: 150px" align="center">&nbsp;<font size="2">
					<form:label path="porefno">Po.Ref.No</form:label>
			</font></td>

			<td align="center" style="width: 150px">&nbsp;<font size="2">
					<form:label path="porefdate">Date</form:label>
			</font></td>

			<td align="center" style="width: 80px">&nbsp;<font size="2">
					<form:label path="principalname">Principal Name</form:label>
			</font></td>
		...
		<c:if test="${!empty viewlist}">
			<c:forEach items="${viewlist}" var="view" varStatus="loop">
				...
				<tr>
					...
					<td><a href="editpo?poref=${view.porefno}"><c:out
								value="${view.porefno}"></c:out></a></td>
