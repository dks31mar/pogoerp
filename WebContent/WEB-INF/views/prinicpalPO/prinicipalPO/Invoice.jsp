...
<div class="row form-group">
	...
	<div class="col-sm-2">
		<span> <input type="text" class="form-control"
			name="dateTodate" id="" value="${date}" ReadOnly></input>
...
<div class="row form-group">
	...
	<div class="col-sm-9">
		<input type="text" name="principalname" placeholder="Principal Name"
			value="${pname}" class="form-control" style="display: inline-block;"
			ReadOnly>
	</div>
</div>
<div class="row form-group">
...
<div class="row form-group">
	...
	<div class="col-sm-2">
		<input type="text" name="InvoiceNo" placeholder="Invoice Number" onkeyup="this.value=value.toUpperCase();"
	...
	<div class="col-sm-3">
		<span> <input type="text" class="form-control"
			name="dateTodate1" id="invoicedate" ReadOnly
			onchange="checkToDayDate();"></input>
		</span>
...
<div class="row form-group">
	...
	<div class="col-sm-3">
		<span> <select name="" class="form-control selectpicker"
			required="required" id="" onChange="searchPro(this.value)">
				<option>---Select---</option>
				<c:if test="${!empty listbyporef}">
					<c:forEach items="${listbyporef}" var="poref" varStatus="loop">
...
<table style="position: relative; visibility: hidden;" border="0"
	id="gettrifchecked">
	<tbody>
		...
		<thead>
			<tr bgcolor="#3C8DBC">
				...
				<td align="center">&nbsp;<font size="2" style="width: 65px"
					color="white"><label>Pending Qty</label></font></td>
				<td align="center">&nbsp;<font size="2" style="width: 65px"
					color="white"><label>Receive Qty</label></font></td>
				<td align="center">&nbsp;<font size="2" style="width: 65px"
					color="white"><label>Pending Qty</label></font></td>
				<td align="center">&nbsp;
					<div class="checkbox">
						<label> <input type="checkbox" value="" id="maincheackbox"
							onclick="toggle(this)"> <span class="cr"><i
				...
				<c:forEach items="${listbyporef}" var="poref" varStatus="loop">
					...
					<tr>
						<td style="display: none;"><input type="hidden" name="date"
							value="" id="getdate${loop.index+1}"></td>
						<td style="display: none;"><input type="hidden"
							name="invoiceno" value="" id="getinvoceno${loop.index+1}">
						</td>
						<td style="display: none;"><input type="hidden"
						...
						<td style="width: 250px">&nbsp; <input readonly name=""
							id="description${loop.index+1}" class="form-control"
							style="text-align: center; width: 238px;"
							value="${poref.productdescription}"></td>
						<td style="right: 7px; position: relative;">&nbsp; <input
							readonly type="text" style="text-align: center;" name=""
							id="tpinjpy${loop.index+1}" value="${poref.tpinjpy}"
							class="form-control"></td>
						<td align="center" style="right: 4px; position: relative;">&nbsp;<input
							readonly type="text" style="text-align: center; width: 55px;"
							name="qty" id="qty${loop.index+1}" class="form-control"
							value="${poref.qty}"></td>
						<td align="center">&nbsp; <input readonly type="text"
							style="text-align: center;" name="" id="totaljpy${loop.index+1}"
							value="${poref.totaljpy}" class="form-control"></td>
						<td align="center">&nbsp;
							<button type="button"
								style="text-align: center; width: 49px; background-color: #3C8DBC; color: aliceblue"
								name="pendingqty" id="pendingqty${loop.index+1}"
								value="${poref.pendingqty}" class="form-control"
								onclick="getacknowlegdement(${loop.index+1});">${poref.pendingqty}</button>
						</td>
						<td align="center">&nbsp; <input type="text"
							style="text-align: center; width: 69px" name="reciveqty"
							id="reciveqty${loop.index+1}" class="form-control"
							onkeyup="getcals(this.value,${loop.index+1});"></td>
						<td align="center">&nbsp; <input type="text"
							style="text-align: center; width: 69px" name=""
							id="remainingqty${loop.index+1}" class="form-control"></td>
						<td align="center">&nbsp;
							<div class="checkbox">
								<label> <input type="checkbox" value="" name="savecheck"
									id="savecheck${loop.index+1}"> <span class="cr"><i
										class="cr-icon glyphicon glyphicon-ok"></i></span>

								</label>
							</div>
						</td>
						<td style="display: none;"><input type="hidden" name=""
							value="${gtotal}" id="grandtotal${loop.index+1}"></td>
						<td style="display: none;"><input type="hidden" name=""
...
<div class="row form-group" position: relative;" onclick=""
	id="pendingformdiv">
