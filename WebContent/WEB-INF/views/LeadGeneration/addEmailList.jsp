...
<div class="row">
	...
	<label  style="margin-left: 250px;margin-top: 8px;"><button href="#" class="btn btn-primary" id="getpopup" style="margin-bottom: -25px;margin-top: -26px;HEIGHT: 28px;margin-left: 561px;"> Add Email </button> </label>
	</div>		
...
<div id="body">
 ...
 <c:if test="${!empty list}">
			...
			<tr>
				...
				<td><a href="#" onclick="editCur(${cur.emaillistid})" title="Edit" align="center" ><span class="glyphicon glyphicon-pencil"></span></a></td>
				<td style="margin"><a href="deleteemail?emaillistid=${cur.emaillistid}"><span class="glyphicon glyphicon-trash" style="margin-left: 19px;" onclick = "return confirm('Are u sure u want to delete?')"></span></a></td>
			</tr>
</c:forEach>
</c:if> 
</tbody>
