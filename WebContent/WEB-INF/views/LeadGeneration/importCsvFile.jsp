...
<form:form method="POST" commandName="fileUploadForm"
	...
	<div class="row">
		<div class="page-heading col-sm-12"
			...
			<strong id=showlabeltext> List of CSV Files </strong> <label
				style="margin-left: 500px;">
				<!-- <button href="#" class="btn btn-primary" id="getpopup1" style="margin-bottom: -25px;margin-top: -26px;HEIGHT: 28px;margin-left: 561px;"> Choose File </button> -->
