...
<div class="row">
	...
	<div class="page-heading col-sm-12"
		...
		<strong id=showlabeltext> Enter Customers Manually </strong> <label
			style="margin-left: 250px; margin-top: 8px;"><button href="#"
				class="btn btn-primary" id="getpopup1"
				style="margin-bottom: -25px; margin-top: -26px; HEIGHT: 28px; margin-left: 561px;">
				Add Email</button> </label> <label style="margin-left: 250px; margin-top: -5px;"><button
				href="#" class="btn btn-primary" id="getpopup2"
				style="margin-bottom: -25px; margin-top: -26px; HEIGHT: 28px; margin-left: 561px;">
				Import</button> </label>
	</div>
	...
	<div id="formid" class="col-md-12" style="left: 20px; height: 34px;">
		<div class="row">
			...
			<div class="col-md-4">
				<span style="color: black;"><strong>Email Address<span
						style="color: red;">*</span>:
				</strong></span>
			</div>

			<div class="col-md-4">
				<span style="color: black;"><strong>Fax Number<span
						style="color: red;">*</span>:
				</strong></span>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<input type="number" class="validate[required] text-input" id="fax"
					style="border-radius: 5px;" value="" name="loginname"
					autofocus="autofocus"></input>
			</div>
	...
	<div id="formid123" class="col-md-12" style="left: 20px; height: 34px;">
		<div class="row">
			...
			<label class="col-sm-4"><a href="importcsvfile">Import
					email file</a> </label> <label class="col-sm-4"><a href="#">Select
					from contacts</a> </label>
		</div>
	</div>
			...
			<c:if test="${!empty addresslist}">
				<c:forEach items="${addresslist}" var="cur" varStatus="loop">
					...
					<tr>
						...
						<td><a href="#" onclick="editCur(${cur.id})" title="Edit"
							align="center"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td style=""><a href="deleteaddress?id=${cur.id}"><span
