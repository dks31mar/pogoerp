...
<legend> Contacts </legend>
  ...
  <label class="col-md-2 control-label" style="">Department<span style="color: red;">*</span></label>
  <div class="col-md-3 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input   name="productcode"  placeholder="Enter Department" required="required"  class="form-control"  type="text" id="department">
 ...
 <div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input   name="loginname" placeholder="Enter Designation" required="required"  class="form-control"  type="text" id="designation">
   ...
   <label class="col-md-2 control-label" style="">Phone<span style="color: red;">*</span></label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-phone-alt"></i></span>
  		<textarea class="form-control" name="address"  placeholder="Enter Phone" required="required" id="phone"></textarea>
...
<label class="col-md-2 control-label" style="">Email<span style="color: red;">*</span></label></label>  
  <div class="col-md-3 inputGroupContainer">
  <div class="input-group">
  ...
  <label class="col-md-2 control-label" >Date of birth<span style="color: red;">*</span></label></label> 
    <div class="col-md-3 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="middlename"   placeholder="Select DOB" id="dob"  class="form-control"  type="text">
...
<div class="form-group">
  ...
  <label class="col-md-2 control-label" >Date of anniversary<span style="color: red;">*</span></label></label> 
    <div class="col-md-3 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="lastname"  placeholder="Select DOA" id="doa" onkeyup="javascript:capitalizelast(this.id, this.value);" class="form-control"  type="text">
...
<div class="form-group">
  ...
  <div class="col-md-2" align="center">
    <button type="button" id="savecontactForm" class="btn btn-warning" >Send <span class="glyphicon glyphicon-send"></span></button>
...
$('#name,#department,#designation,#phone,#email,#dob,#doa').click(function (){
	 $('#msg0').hide();
	$('#msg1').hide();
	 $('#msg2').hide();
	 $('#msg3').hide();
