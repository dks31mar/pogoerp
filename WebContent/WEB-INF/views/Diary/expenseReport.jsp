...
<form:form method="POST" action="saveexpensereport" commandName="command"> 
<div class="row">
	<div class="page-heading col-sm-11" id=""
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="ason"  type="radio" name="potype"checked="checked"> As On
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "hide1">From:<input type="text" style="color: black;" id="datepicker1" name = "startdate" value="<%=dateFormat.format(date) %>" ReadOnly></span> 
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "hide2">To: <input type="text" style = "color:black" id="datepicker2" name = "enddate" value="<%=dateFormat.format(date) %>" ReadOnly></span> 
	                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Search" name = "command" style="color: black;"/>
	</div>
</div>
