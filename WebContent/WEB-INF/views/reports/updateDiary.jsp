...
<div class="row">
	...
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span><span> New Entry
			in Diary</span> <label style="margin-left: 250px; margin-top: 8px;"><a
			href="#" class="btn btn-primary"> View Diary Entries</a> </label>
...
<div class="container">
	...
	<form:form class="well form-horizontal" name="forp"
		action="updatediary?empid=${empid}&planid=${planid}" method="POST"
		commandName="addDiaryBean">
		...
		<fieldset>
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							value="${diarydata.diaryId}" class="form-control" name="diaryId"
							readonly="readonly" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							class="glyphicon glyphicon-user"></i></span> <input type='text'
							value="${diarydata.organization}" name=Organization
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							name="address" id="address" style="height: 106px;"
							class="form-control" value="${diarydata.address}">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							class="form-control" id="mob" value="${diarydata.mobileno}"
							placeholder="8285080678" type="text" required="required">
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							value="${diarydata.email}" required="required" type="email">
					</div>
				</div>
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							value="${diarydata.date}" placeholder="Select Date">
					</div>
				</div>
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							<option value="${diarydata.planId}">
								${diarydata.planName }</option>
			...
			<div class="form-group">
				...
				<div class="col-md-3 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							class="glyphicon glyphicon-user"></i></span> <input name="objective"
							type="text" class="form-control" style="height: 106px;"
							value="${diarydata.objective}">
					</div>
				</div>
			</div>
