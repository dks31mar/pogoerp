			...
			<div>
				...
				<div class="row">
					...
					<div class="page-heading col-sm-11"
						...
						<span class="glyphicon glyphicon-user"></span> Sales Funnel Report
						</b> <label style="margin-left: 250px; margin-top: 8px;"><a
							href="#" class="btn btn-info"> <strong> Sales Funnel</strong></a>
