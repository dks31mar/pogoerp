...
<div class="row">
	...
	<div class="page-heading col-md-11.5"
		...
		<span class="glyphicon glyphicon-user"></span><span>Pending
			Plan</span>
		...
		<c:if test="${!empty diarydata}">
			<c:forEach items="${diarydata}" var="diarylist" varStatus="loop">
				...
				<tr>
					...
					<td id="appoit${loop.index+1}" style="text-align: center;"><a
						href="pendingThingsTo?id=${diarylist.enteryuserId}&planid=2">${diarylist.totalappointment }</a></td>

					<td id="phon${loop.index+1}" style="text-align: center;"><a
						href="pendingThingsTo?id=${diarylist.enteryuserId}&planid=4">${diarylist.totalphone }</a></td>
					<td id="emal${loop.index+1}" style="text-align: center;"><a
						href="pendingThingsTo?id=${diarylist.enteryuserId}&planid=3">${diarylist.totalemail }</a></td>
					<td id="smss${loop.index+1}" style="text-align: center;"><a
						href="pendingThingsTo?id=${diarylist.enteryuserId}&planid=1">${diarylist.totalsms }</a></td>
					<td id="otherss${loop.index+1}" style="text-align: center;"><a
						href="pendingThingsTo?id=${diarylist.enteryuserId}&planid=0">${diarylist.totalothers }</a></td>
					<td id="total12${loop.index+1}" style="text-align: center;"><a
						href="pendingThingsTo?id=${diarylist.enteryuserId}&planid=0">${diarylist.total }</a></td>
				</tr>
	...
	<tfoot>
		<tr>
			...
			<td style="text-align: center;"><a
				href="pendingThingsTo?id=0&planid=2" id="appoit"></a></td>
			<td id="" style="text-align: center;"><a
				href="pendingThingsTo?id=0&planid=4" id="phon"></a></td>
			<td id="" style="text-align: center;"><a
				href="pendingThingsTo?id=0&planid=3" id="emal"></a></td>
			<td id="" style="text-align: center;"><a
				href="pendingThingsTo?id=0&planid=1" id="smss"></a></td>
			<td id="" style="text-align: center;"><a href="" id="otherss"></a></td>
			<td id="" style="text-align: center;"><a
				href="pendingThingsTo?id=${diarylist.enteryuserId}&planid="
				id="total12"></a></td>
		</tr>
	</tfoot>
</table>
