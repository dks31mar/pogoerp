...
xhttp.open("GET", "getsubmenu", true);
xhttp.send(select);
} */
...
$.ajax({
   ...
   // data: p,
    ...
    success: function (data) {
    	...
    	var data3=data2.split(',');
    	jQuery('#world-map-markers').html('');
    	jQuery('#menu-in-short-cut-form').html('');
    	jQuery('#titlename').html('');
    	$("#titlename").append('<h3 class="box-title">'+select+' Option</h3>');
    	$("#titlename").append('<div class="box-tools pull-right"><button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button><button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button></div>');
    	...
    	if(data5!=''){
    	for(var j=0;j<=data5.length;j=j+2){
    		
    		$("#world-map-markers").append('<a href="'+data5[1]+'" target="_blank" class="btn btn-info btn-block" role="button" style="margin-left: 6px;><span class="glyphicon glyphicon-list-alt"></span>'+data5[0]+'</a>');
    		data5='';
    	} 
    	}else{
    		$("#world-map-markers").append('<h2>Sorry</h2><br><h3>Please contact to Admin</h3>');
    	}
    	}
    		
    	/* var menuReplace=data.replace('[','');
    	var menuReplace2=menuReplace.replace(']','');
    	var menuName=menuReplace2.split(',');
    	alert(menuReplace);
    	alert(menuReplace2);
    	alert(menuName[0]);
    	...
    	for(var i=0;i<menuName.length;i++){
    		...
    		$("#world-map-markers").append('<a href="test" target="_blank" class="btn btn-info btn-block" role="button" style="margin-left: 6px;><span class="glyphicon glyphicon-list-alt"></span>'+menuName[i]+'</a>');
...
%>
	<div class="wrapper">
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header"><img
							...
							<p>
								<%=name %>- Web Developer <small>Member since Nov. 2012</small>
     ...
     <li class="treeview">
		...
		<ul>
			<c:forEach var="listValue1" items="${submenu}"> 
				
				<li><a href="#" id="${listValue}"><i class="fa fa-circle-o"></i>${listValue1}</a></li>
				</a>
			</c:forEach>
		</ul>
		...
		<ul class="sidebar-menu">
			<li class="header">MAIN NAVIGATION</li>
			<c:if test="${not empty lists}">
				<c:forEach items="${lists}" var="contactMap" varStatus="status">
					<li class="treeview"><a href="getsubmenu"> <i
							class="fa fa-pie-chart"></i> <span id="">${contactMap.key}<span>
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="box box-success">
						<div class="box-header with-border" id="titlename">
								...
								<li class="item">
									...
									<div class="product-info">
										<a href="javascript:void(0)" class="product-title">Xbox
											One <span class="label label-danger pull-right">$350</span>
