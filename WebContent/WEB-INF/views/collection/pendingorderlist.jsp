...
<div class="row">
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> Pending Order List <input
			id="ason" type="radio" name="potype" checked="checked"> As On
		<input id="period" type="radio" name="potype" />Period <span
			id="hide1">From:<input type="text" style="color: black;"
			id="datepicker1" value="<%=dateFormat.format(date) %>" ReadOnly></span>
		<span id="hide2">To: <input type="text" style="color: black"
			id="datepicker2" value="<%=dateFormat.format(date) %>" ReadOnly></span>
...
<table class="responstable">
	<tbody>
		<tr>
			...
			<th>Invoice Date</th>
			<th>Invoice no</th>
			<th data-th="Driver details"><span>Order Ref.No</span></th>
			<th>Customer Name</th>
			<th>Add/Edit</th>
		...
		<tr>
			<td>1</td>
			<td>13/12/2016</td>
			<td>YIPL/2016-17/TI/D/1</td>
			<td>ORD002</td>
			<td>Dabur India Ltd.</td>
			<td><a href="addcollection">Add/Edit Collection</a></td>
