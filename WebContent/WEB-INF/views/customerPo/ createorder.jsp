	...
	<div style="border: 1px solid #CCCCCC; padding: 7px; width: 93%">
		<div class="row form-group">
			...
			<div class="col-sm-3">
				<span> <input type="text" class="form-control"
					name="Customerlocation" placeholder="Customer Location."
		...
		<div>
			...
			<div class="row form-group">
				...
				<div class="col-sm-4">
					<span> <input type="text" class="form-control"
						name="Orderno" placeholder="Order No." id="Orderid" size="120"></input>
		...
		<div class="row form-group">
			...
			<div class="col-sm-3">
				<span> <input type="text" class="form-control"
					name="dateTodate" placeholder="Order Date" id="datepicker1"
					value="${date}" ReadOnly title="DD/MM/YYYY"></input>
				</span>
			...
			<div class="col-sm-3">
				<span> <input type="text" class="form-control"
					name="recivedate" placeholder="Order Receive Date" id="datepicker2"
					value="${date}" ReadOnly title="DD/MM/YYYY"></input>
				</span>
		...
		<table style="width: 100%; bottom: 15px; position: relative;"
			...
			<thead>
				<tr bgcolor="#3C8DBC">
					...
					<td class="col-sm-3 form-level" style="width: 80px" align="center">&nbsp;<font
						size="2" color="white"> <label>Product Type</label></font></td>
					...
					<td align="center">&nbsp;
						<div class="checkbox">
							<label> <input type="checkbox" value=""
								id="maincheackbox" onclick="toggle(this)"> <span
		...
		<table>
			<tr>
				...
				<td style="right: 7px; position: relative;">&nbsp; <input
					type='text' style='text-align: center;' name='disc' id='disc'
