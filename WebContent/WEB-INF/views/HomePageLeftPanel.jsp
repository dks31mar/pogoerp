	...
	<div class="left-panel">
		<div class="userprofile">
			<div class="profile_pic">
				<img src="resources/image/profile-image.jpg" alt="..."
			...
			<div class="profile_info">
				...
				<h2><%=name %></h2>
				<h2>
					<label title="dks31mar"></label>
				</h2>
				<h2>
					<span class="glyphicon glyphicon-earphone"></span> :87463874
				</h2>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" style="border-top: 1px solid #F7F7F7;">
				...
				<tr>
					...
					<td class="menuTD">
						...
						<!--  <form action="getleftmenu" method="get"> --> <c:if
						...
						</c:if> <!-- <button class="dropbtn" type="submit">Menu</button> -->

						</div> <!-- </form>         --> <!--   Vineet 10 October 2008 purpose to match condition for highlighting selected menu     -->
					</td>
				</tr>
