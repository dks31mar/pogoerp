...
<div class="row">
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-file"> </span> <span>Attachment
			List</span>
		...
		<c:if test="${!empty filesList}">
			<c:forEach items="${filesList}" var="filedata" varStatus="count">
				...
				<tr>
					...
					<td><a href="download-files?id=${filedata.cusfileId}"
						title="Download"> <span
							class="glyphicon glyphicon-cloud-download"
							style="margin-left: 27px;"></span></a> <a
						href="delete-file?id=${filedata.cusfileId}" title="Delete"> <span
