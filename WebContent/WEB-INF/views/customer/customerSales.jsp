...
<div class="row">
	<div class="page-heading col-sm-11"
		...
		<span class="glyphicon glyphicon-user"></span> <span>Create
			Customer</span> <label style="margin-left: 540px;"><a
			href="getSalesList" style="margin-top: -3px;" class="btn btn-primary">
				Sales List </a> </label>
				...
				<form:form action="savecontact" method="POST"
					...
					<div class="form-group">
						<label class="col-md-2 control-label"><strong>
								Name</strong><span style="color: red;">*</span></label>
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input type="text"
								name="contactName" class="form-control">
						</div>
						<br> <label class="col-md-2 control-label"><strong>Designation</strong><span
							style="color: red;">*</span></label>
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-star"></i></span> <select name=""
								class="form-control" id="designationOption"
								onclick="contactDesignation();">
								<option value="">--Select Designation--</option>
							</select>
						</div>
						<br> <label class="col-md-2 control-label"><strong>Department</strong><span
							style="color: red;">*</span></label>
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-star"></i></span> <select name="depId"
								class="form-control" id="departOptions">
								<option>--Select Department--</option>

							</select>
						</div>
						<br> <label class="col-md-2 control-label"><strong>Email</strong><span
							style="color: red;">*</span></label>
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-star"></i></span> <input name="contemail"
								class="form-control" type="text">
						</div>
						<br> <label class="col-md-2 control-label"><strong>Phone</strong><span
							style="color: red;">*</span></label>
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-star"></i></span> <input name="phone"
								class="form-control" type="text">
						</div>
					</div>
					<div>
						...
						<button type="submit" class="btn btn-warning"
							style="margin-left: 406px;">Save</button>
						<button type="button" class="btn btn-warning"
							style="margin-left: 20px;" data-dismiss="modal">Close</button>
					</div>
...
<form:form class="well form-horizontal" action="saveCustomer"
	method="POST" commandName="customerSalesBean" style="width: 1217px;">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						name="creationDate" readonly="readonly" id="enquirydate"
						value="${today}" placeholder="Select Date" class="form-control"
						type="text">
				</div>
			</div>
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-calendar"></i></span> <input name="orderdate"
						placeholder="Select Date" required="required" id="orderdate"
				...
				<div class="input-group">
					...
					<div id="errors">
						<input name="organisation" placeholder="Organisation Name"
							id="organisation" class="form-control" type="text"
							onblur="verifyOrganisation();">
					</div>
				</div>
			</div>
			<label class="col-md-2 control-label">Alias<span
				style="color: red;">*</span></label>
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="glyphicon glyphicon-user"></i></span> <input type="text"
						class="form-control" name="orgShortName" placeholder="Name">
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<label class="col-md-2 control-label">District<span
				style="color: red;">*</span></label>
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						name="telephoneNo" class="form-control selectpicker"
						placeholder="121-12457" required="required" type="text">
				</div>
			</div>
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						class="form-control" placeholder="Person Name" required="required"
						type="text">
				</div>
			</div>
			<div>
				<a href="#" onclick="contactP();" class="btn btn-success"
					data-toggle="modal" data-target="#myModal" title="Add More">+</a>
			</div>
		</div>
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						class="form-control selectpicker" placeholder="E-Mail Address"
			...
			<div class="col-md-3 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						name="customerLevelId" class="form-control" required="required">
			...
			<div class="col-md-3 selectContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						class="form-control selectpicker" placeholder="Mobile No"
