...
DatePickerControl.buttonTitle     = "Thing to to..";
...
DatePickerControl.createButton = function(input, useId)
{
	...
	*/
	...
	calButton.style.cursor = "pointer";
	calButton.style.verticalAlign = "top";//change bottom to top by yogesh vaishnav on 30/Apr/2012
	calButton.style.height = input.offsetHeight;
	calButton.src = "Resources/image/calender1.png";
	calButton.style.width = "16px";
...
DatePickerControl.show = function()
{
	...
	if (!this.displayed){
		...
		document.getElementById('blackshownew').style.display="block" 
...
{
	var vCode = "";
	vCode += "<table cellspacing='0' cellpadding='0' class='calframe' id='" + this.calFrameId + "'>";
...
DatePickerControl.getHeaderCode = function()
{
	...
	vCode += "</tr></table>";
	vCode += "</td></tr>";
	vCode += "<tr onclick='newmonthlytaskcalender();'><td colspan='8' class='navbutton' style='padding:3px;' align='center' >&lt;&lt; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Monthly &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&gt;&gt;</td></tr>";
	return vCode;
}
...
{
	nPos = 0;
	while ((hLayer) && !( /(body|html)/i.test(hLayer))){
